...
- **Bug reports** (`bug_report.yml`): include sections for "Describe the bug", "Steps to reproduce", "Expected behavior", "Log output", "Operating system", ".NET version", and "SQL Server version".
